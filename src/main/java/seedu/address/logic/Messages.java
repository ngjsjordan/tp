...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_PERSON_DISPLAYED_INDEX = "The client index provided does not exist";
    public static final String MESSAGE_INVALID_APPOINTMENT_DISPLAYED_INDEX =
            "The appointment index provided does not exist";
