...
public class SearchAppointmentCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Finds all appointments whose details contain any of "
            ...
            + "Can optionally filter by timeframe using time/ prefix.\n"
            + "Parameters: [KEYWORD [MORE_KEYWORDS]...] [time/TIMEFRAME]\n"
            ...
            + "  " + COMMAND_WORD + " time/today (finds all appointments scheduled for today)\n"
            + "  " + COMMAND_WORD + " alice time/today (finds today's appointments with alice)\n";
