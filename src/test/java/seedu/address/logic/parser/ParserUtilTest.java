...
public class ParserUtilTest {
    ...
    private static final String VALID_PROPERTY_TYPE = "HDB_4";
    ...
    public void parseAddress_null_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> ParserUtil.parseAddress((String) null, (String) null));
    }

    @Test
    public void parseAddress_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseAddress(INVALID_ADDRESS, INVALID_PROPERTY_TYPE));
    }

    @Test
    public void parseAddress_validValueWithoutWhitespace_returnsAddress() throws Exception {
        Address expectedAddress = new Address(VALID_ADDRESS, new AddressType(VALID_PROPERTY_TYPE));
        assertEquals(expectedAddress, ParserUtil.parseAddress(VALID_ADDRESS, VALID_PROPERTY_TYPE));
    }
    ...
    public void parseAddress_validValueWithWhitespace_returnsTrimmedAddress() throws Exception {
        ...
        Address expectedAddress = new Address(VALID_ADDRESS, new AddressType(VALID_PROPERTY_TYPE));
        assertEquals(expectedAddress, ParserUtil.parseAddress(addressWithWhitespace, VALID_PROPERTY_TYPE));
    }
